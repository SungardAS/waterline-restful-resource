...
```sh
$ npm install waterline-sails-restful-resource
```

[![NPM](https://nodei.co/npm/waterline-sails-restful-resource.png?downloads=true&stars=true)](https://nodei.co/npm/waterline-sails-restful-resource/)
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8acf2fc2ca0aca8a3018e355ad776ed7 "githalytics.com")](http://githalytics.com/balderdashy/waterline-sails-restful-resource/FAQ.md)
